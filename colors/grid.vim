" by Simon Zuluaga
" https://github.com/sicozz/grid.vim
...
" ==========================
"  >> (inspired by https://github.com/tomasiser/vim-code-dark and https://github.com/chriskempson/base16-vim and https://github.com/jaredgorski/fogbell)
...
" Color Variables
" ==========================
let s:voidBlack = {'gui': '#000c0c', 'cterm256': '233'}   " Background
let s:voidBlack2 = {'gui': '#000c0c', 'cterm256': '235'}  " Number Background
let s:voidGray1 = {'gui': '#002020', 'cterm256': '237'}   " Current line
let s:voidGray2 = {'gui': '#003333', 'cterm256': '239'}   " Telescope current line
let s:voidGray3 = {'gui': '#f5f5f5', 'cterm256': '242'}   " Number/comment text
let s:voidGray4 = {'gui': '#ff0000', 'cterm256': '249'}   " TODO
let s:voidSteel = {'gui': '#95ffff', 'cterm256': '252'}   " Text
let s:voidBlue = {'gui': '#ff0000', 'cterm256': '109'}    " TODO
let s:voidGreen = {'gui': '#9effe4', 'cterm256': '72'}    "
let s:voidGold = {'gui': '#fbde29', 'cterm256': '136'}
let s:voidRed = {'gui': '#fa7134', 'cterm256': '1'}
let s:voidRed2 = {'gui': '#262600', 'cterm256': '196'}
